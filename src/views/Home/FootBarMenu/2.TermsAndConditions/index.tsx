  ...
  return (
    <div id='clause-wrapper'>
      ...
      <h1 className='title'><strong>이용약관</strong></h1>
        ...
        <br></br>
        <p><b><h3>제3조 (약관 등의 명시와 설명 및 개정)</h3></b></p>
        ...
        <br></br>
        <p><b><h3>제4조(서비스의 제공 및 변경)</h3></b></p>
        <p>&nbsp;① “몰”은 다음과 같은 업무를 수행합니다.
          <ol>1. 재화 또는 용역에 대한 정보 제공 및 구매계약의 체결</ol>
          <ol>2. 구매계약이 체결된 재화 또는 용역의 배송</ol>
          <ol>3. 기타 “몰”이 정하는 업무</ol>
        </p>
        ...
        <p>&nbsp;② “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.</p>
          <ol>1. 가입신청자가 이 약관 제7조제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 “몰”의 회원재가입 승낙을 얻은 경우에는 예외로 한다.</ol>
          <ol>2. 등록 내용에 허위, 기재누락, 오기가 있는 경우</ol>
          <ol>3. 기타 회원으로 등록하는 것이 “몰”의 기술상 현저히 지장이 있다고 판단되는 경우</ol>
        ...
        <br></br>
        <p><b><h3>제7조(회원 탈퇴 및 자격 상실 등)</h3></b></p>
        <p>&nbsp;① 회원은 “몰”에 언제든지 탈퇴를 요청할 수 있으며 “몰”은 즉시 회원탈퇴를 처리합니다.</p>
        <p>&nbsp;② 회원이 다음 각 호의 사유에 해당하는 경우, “몰”은 회원자격을 제한 및 정지시킬 수 있습니다.</p>
          <ol>1. 가입 신청 시에 허위 내용을 등록한 경우</ol>
          <ol>2. “몰”을 이용하여 구입한 재화 등의 대금, 기타 “몰”이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우</ol>
          <ol>3. 다른 사람의 “몰” 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우</ol>
          <ol>4. “몰”을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</ol>
        ...
        <br></br>
        <p><b><h3>제9조(구매신청 및 개인정보 제공 동의 등)</h3></b></p>
        <p>&nbsp;① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.</p>
          <ol>1. 재화 등의 검색 및 선택</ol>
          <ol>2. 받는 사람의 성명, 주소, 전화번호, 전자우편주소(또는 이동전화번호) 등의 입력</ol>
          <ol>3. 약관내용, 청약철회권이 제한되는 서비스, 배송료․설치비 등의 비용부담과 관련한 내용에 대한 확인</ol>
          <ol>4. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시</ol>
          <ol>5. 재화등의 구매신청 및 이에 관한 확인 또는 “몰”의 확인에 대한 동의</ol>
          <ol>6. 결제방법의 선택</ol>
        ...
        <p>&nbsp;①  “몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.</p>
          <ol>1. 신청 내용에 허위, 기재누락, 오기가 있는 경우</ol>
          <ol>2. 미성년자가 담배, 주류 등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우</ol>
          <ol>3. 기타 구매신청에 승낙하는 것이 “몰” 기술상 현저히 지장이 있다고 판단하는 경우</ol>
        ...
        <br></br>
        <p><b><h3>제11조(지급방법)</h3></b>“몰”에서 구매한 재화 또는 용역에 대한 대금지급방법은 다음 각 호의 방법중 가용한 방법으로 할 수 있습니다. 단, “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의 수수료도  추가하여 징수할 수 없습니다.</p>
          <ol>1. 폰뱅킹, 인터넷뱅킹, 메일 뱅킹 등의 각종 계좌이체</ol>
          <ol>2. 선불카드, 직불카드, 신용카드 등의 각종 카드 결제</ol>
          <ol>3. 온라인무통장입금</ol>
          <ol>4. 전자화폐에 의한 결제</ol>
          <ol>5. 수령 시 대금지급</ol>
          <ol>6. 마일리지 등 “몰”이 지급한 포인트에 의한 결제</ol>
          <ol>7. “몰”과 계약을 맺었거나 “몰”이 인정한 상품권에 의한 결제</ol> 
          <ol>8. 기타 전자적 지급 방법에 의한 대금 지급 등</ol>
        <br></br>
        <p><b><h3>제12조(수신확인통지․구매신청 변경 및 취소)</h3></b></p>
        ...
        <p><b><h3>제14조(환급)</h3></b>“몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</p>
        <p><b><h3>제15조(청약철회 등)</h3></b></p>
        ...
        <p>&nbsp;② 이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.</p>
          <ol>1. 이용자에게 책임 있는 사유로 재화 등이 멸실 또는 훼손된 경우(다만, 재화 등의 내용을 확인하기 위하여 포장 등을 훼손한 경우에는 청약철회를 할 수 있습니다)</ol>
          <ol>2. 이용자의 사용 또는 일부 소비에 의하여 재화 등의 가치가 현저히 감소한 경우</ol>
          <ol>3. 시간의 경과에 의하여 재판매가 곤란할 정도로 재화등의 가치가 현저히 감소한 경우</ol>
          <ol>4. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본인 재화 등의 포장을 훼손한 경우</ol>
        ...
        <p><b><h3>제19조(회원의 ID 및 비밀번호에 대한 의무)</h3></b></p>
        ...
        <p><b><h3>제20조(이용자의 의무)</h3></b> 이용자는 다음 행위를 하여서는 안 됩니다.</p>
          <ol>1. 신청 또는 변경시 허위 내용의 등록</ol>
          <ol>2. 타인의 정보 도용</ol>
          <ol>3. “몰”에 게시된 정보의 변경</ol>
          <ol>4. “몰”이 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시</ol>
          <ol>5. “몰” 기타 제3자의 저작권 등 지적재산권에 대한 침해</ol>
          <ol>6. “몰” 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위</ol>
          <ol>7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 몰에 공개 또는 게시하는 행위</ol>
        <p><b><h3>제21조(연결“몰”과 피연결“몰” 간의 관계)</h3></b></p>
        ...
        <p><b><h3>제22조(저작권의 귀속 및 이용제한)</h3></b></p>
